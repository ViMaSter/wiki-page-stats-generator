...
public abstract class GeneratePageStatsMarkdown
{
    ...
    public static void Execute([FromService]HttpClient httpClient, string azurePAT, string organization, string project, string wikiIdentifier, string outputPath)
    {
        ...
        var last30Days = Enumerable.Range(1, 30).Select(i => DateTime.Now.AddDays(-i).ToString("dd.MM.yyyy")).ToArray();
        ...
        foreach (var (page, viewCountByDay) in pageViewCountByDay)
        {
